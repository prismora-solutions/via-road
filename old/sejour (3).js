...
const SEJOUR = {
  ...
  jours: [
    ...
    // ─────────────────────────────
    {
      ...
      ambiance: "On pose le CC, on respire, on laisse le marais venir à nous.",
      histoire: "Il y a très longtemps — au temps des Romains et des premiers rois de France — l'endroit où nous allons était une mer intérieure. La mer remontait jusqu'ici depuis l'Atlantique, formant un immense golfe appelé le Golfe des Pictons. Puis, peu à peu, des moines au Moyen Âge ont commencé à assécher les terres en creusant des canaux. Des générations de maraîchins ont continué leur travail pendant des siècles, bêche après bêche, pour transformer cette mer en prairies et en jardins. Résultat : il y a aujourd'hui plus de 8 000 km de canaux ici — de quoi relier Paris à New York. C'est le deuxième plus grand marais de France, et ses habitants s'appelaient les maraîchins. Ils se déplaçaient en barque comme d'autres se déplacent à vélo, propulsaient leur batai à la pigouille, et pêchaient l'anguille dans les conches. Coulon, le village où l'on arrive, est la capitale de la Venise Verte — la partie encore mouillée, là où les arbres poussent les pieds dans l'eau et où les canaux se referment au-dessus des barques comme un tunnel de verdure. Ce soir, on fait partie du paysage.",
      etapes: [
        {
    ...
    // ─────────────────────────────
    {
      ...
      histoire: "Hier on a posé les yeux sur le marais. Aujourd'hui on y entre vraiment — à pied, comme les maraîchins qui parcouraient les berges pour aller de village en village. Avant que les routes existent, les canaux étaient les seules rues du marais. Chaque hameau avait son port, chaque famille sa barque. La Garette, notre destination du matin, est l'un des villages les mieux préservés de ce monde disparu : une longue rue piétonne bordée de maisons de pêcheurs-paysans, chacune avec son embarcadère privé côté canal. Ces maisons sont construites sur des buttes artificielles — des mottes de terre surélevées — pour ne pas être inondées en hiver quand le marais se remplit. Les habitants vivaient dans une semi-autarcie : ils pêchaient l'anguille, cultivaient les mojettes (haricots blancs), fauchaient le foin pour leurs vaches maraîchines, et taillaient les frênes têtards pour le bois de chauffage. Cette taille régulière donnait aux arbres leur silhouette si particulière — un tronc trapu surmonté de branches qui repartent comme des bras levés. Aujourd'hui, les frênes têtards sont menacés par un champignon. Se souvenir d'eux en marchant, c'est déjà les préserver un peu.",
      etapes: [
        {
    ...
    // ─────────────────────────────
    {
      ...
      histoire: "Dernier matin. Arçais, d'où on repart pour cette dernière balade, est un village du marais mouillé — celui qu'on a traversé à pied, vu de l'eau, exploré en énigmes. Mais on n'a fait qu'effleurer l'histoire de cet endroit. Le Marais Poitevin c'est aussi la bataille permanente entre l'eau et la terre — depuis les moines du Moyen Âge jusqu'aux agriculteurs d'aujourd'hui qui débattent de la gestion des niveaux d'eau. C'est un territoire fragile : les zones humides disparaissent trois fois plus vite que les forêts dans le monde. Ici, des associations, des éleveurs et des naturalistes se battent pour maintenir les prairies inondées en hiver, habitat des oiseaux migrateurs et des plantes rares. Avant de partir, on traverse une dernière fois ces canaux plats, ces frênes têtards, ces prairies d'herbe grasse. On croise peut-être des hérons, des ragondins, des libellules. Dans quelques heures on sera sur l'autoroute. Mais le marais, lui, continuera de fonctionner à son rythme d'eau et de silence — comme il le fait depuis que les moines ont commencé à creuser, il y a plus de mille ans.",
      etapes: [
        {
