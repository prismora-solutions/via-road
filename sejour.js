...
const SEJOUR = {
  ...
  jours: [
    ...
    // ─────────────────────────────
    {
      id: "j1", numero: 1,
      label: "Jeudi 14 mai",
      titre: "Premier coup de pigouille",
      emoji: "🚣",
      km_balade: "~3 km · journée douce",
      ambiance: "On pose le CC, on respire, on laisse le marais venir à nous.",
      histoire: "Il y a très longtemps — au temps des Romains et des premiers rois de France — l'endroit où nous allons était une mer intérieure. La mer remontait jusqu'ici depuis l'Atlantique, formant un immense golfe appelé le Golfe des Pictons.\n\nPuis, peu à peu, des moines au Moyen Âge ont commencé à assécher les terres en creusant des canaux. Des générations de maraîchins ont continué leur travail pendant des siècles, bêche après bêche, pour transformer cette mer en prairies et en jardins.\n\nRésultat : il y a aujourd'hui plus de 8 000 km de canaux ici — de quoi relier Paris à New York. C'est le deuxième plus grand marais de France, et ses habitants s'appelaient les maraîchins. Ils se déplaçaient en barque comme d'autres se déplacent à vélo, propulsaient leur batai à la pigouille, et pêchaient l'anguille dans les conches.\n\nCoulon, le village où l'on arrive, est la capitale de la Venise Verte — la partie encore mouillée, là où les arbres poussent les pieds dans l'eau et où les canaux se referment au-dessus des barques comme un tunnel de verdure. Ce soir, on fait partie du paysage.",
      photo: { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/Coulon-Barques_plates.jpg/800px-Coulon-Barques_plates.jpg", credit: "Wikimedia Commons" },
      etapes: [
        {
    ...
    // ─────────────────────────────
    {
      ...
      photo: { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/28/Canal_de_la_Garette_-_20150810_16h00_%2811061%29.jpg/800px-Canal_de_la_Garette_-_20150810_16h00_%2811061%29.jpg", credit: "Wikimedia Commons" },
      etapes: [
        {
    ...
    // ─────────────────────────────
    {
      id: "j3", numero: 3,
      label: "Samedi 16 mai",
      titre: "Conches, énigmes et feux follets",
      emoji: "🌀",
      ...
      photo: { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/Conche_des_cabanes_-_20150810_14h26_%2811048%29.jpg/800px-Conche_des_cabanes_-_20150810_14h26_%2811048%29.jpg", credit: "Wikimedia Commons" },
      etapes: [
        {
    ...
    // ─────────────────────────────
    {
      ...
      titre: "On n'oubliera pas les frênes têtards",
      emoji: "🍂",
      ...
      photo: { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/df/Ar%C3%A7ais_%284%29.JPG/800px-Ar%C3%A7ais_%284%29.JPG", credit: "Wikimedia Commons" },
      etapes: [
        {
